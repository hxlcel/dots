{
  ...
  programs.rofi = {
    ...
    terminal = "kitty";
    extraConfig = {
      font = "Atkinson Hyperlegible Next Regular 14";
...
#         bg-alt = mkLiteral "#${config.colorScheme.palette.base09}";
#         foreground = mkLiteral "#${config.colorScheme.palette.base01}";
#         selected = mkLiteral "#${config.colorScheme.palette.base08}";
#         active = mkLiteral "#${config.colorScheme.palette.base0B}";
#         text-selected = mkLiteral "#${config.colorScheme.palette.base00}";
#         text-color = mkLiteral "#${config.colorScheme.palette.base05}";
#         border-color = mkLiteral "#${config.colorScheme.palette.base0F}";
